...
export const CENSUS = [
  ...
  { token: "ŋ", unicodeHex: "F0027", object: "compound: G's place (velar) + N's manner (nasal), conjoined N+G", sound: "ŋ (\"sing\")", class: "ligature", ring: "made", twin: null, chirality: null, note: "Resolves 00-laws.md's COLLISION LOG C6 (ŋ ligature vs. K+N adjacency) as N+G rather than K+N -- G is the VOICED member of the K/G rotation-twin pair, matching every other voiced/nasal derivation in this alphabet (T/D, S/Z, B/P all pair with their voiced half too), where the log's own loose 'K+N' phrasing didn't. Authored as its own coherent glyph, same treatment as the vowel ligatures -- NOT N and G mechanically overlaid." },
];
